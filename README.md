...
This repository is supposed to help to reproduce the work in the paper "Proactive Conformance Checking: An Approach for Predicting Deviations in Business Processes". The corresponding approach BPDP was originally proposed in [1] and is now published as an extension.
